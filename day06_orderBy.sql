...
select * from kisiler ORDER BY adres ASC; -- Ascending (asc) yazmasak da sirali verir



-- kisiler tablosunu adres'e göre tersten sıralayarak sorgulayınız.
select * from kisiler ORDER BY adres DESC; -- DESCENDING (DESC) tersten siralama yapar
